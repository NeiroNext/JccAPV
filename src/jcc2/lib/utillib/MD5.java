...
public class MD5 extends RTObject
{
  ...
  public static ClassContainer getClassContainer()
  {
    if (ctClass != null)
      return ctClass;
    ClassContainer container = new ClassContainer("MD5");
    container.className = "jcc2/lib/utillib/MD5";
    ctClass = container;
    return ctClass;
  }
  ...
  public static void initClassContainer()
  {
    ...
    method = new MethodContainer("calculate", Type.TYPE_STRING, args, null, mid++);
    container.addMethod(method);
  ...
  private StringBuffer toHexString() {
      ...
      for (int j = 0; j < 4; ++j) {
          for (int i = 0; i < 32; i += 8) {
              ...
              if (myByte < 16) {
                  mystring.append("0").append(Long.toString(myByte, 16));
              } else {
                  mystring.append(Long.toString(myByte, 16));
              }
          }
      }
      return (mystring);
