...
public class Type
{
    ...
    public static final int T_CALLBACK = 21;
    public static final int T_OBJECT = 22;
    ...
    public static Type TYPE_OBJECT = new Type(T_OBJECT, 0);
    public static Type TYPE_AOBJECT = new Type(T_OBJECT, 1);
    public static Type TYPE_CALLBACK = new Type(T_CALLBACK, 0);
    ...
    public Type (int primitive, int arrayDepth)
    {
        if (arrayDepth == 0)
        {
            if (primitive == T_STRING || primitive == T_OBJECT)
            {
    ...
    public static String genSpec (Type type)
    {
        ...
        if (t.primitive != -1)
        {
            if (t.primitive == T_INT)
                ...
                sSpec += "V";
            else if (t.primitive == T_OBJECT)
                sSpec += "Ljava/lang/Object;";
            else if (t.primitive == T_CALLBACK)
                sSpec += "I";
            else
                sSpec += "<Unknown>";
        }
