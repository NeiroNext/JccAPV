...
public interface RuntimeConst
{
    ...
    public static final int CALL_CALLBACK = 166;
    public static final int NEWOBJECT = 167;

    public static final int STR_TO_INT = 168;
    public static final int STR_TO_FLOAT = 169;
    public static final int CTOS = 170;
}
